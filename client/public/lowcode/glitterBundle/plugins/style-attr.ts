...
export const styleAttr: {
  tag: string;
  title: string;
  innerHtml: (gvc: GVC, data: { [name: string]: string }) => string;
}[] = [
  {
    tag: 'size',
    title: '大小',
    ...
    innerHtml: (gvc, data) => {
      ...
      return (
        ...
        ` <div class="alert alert-primary mt-2">
            ...
            </div><div class="mb-2" style="width: 100%;height: 1px;background-color: white;"></div>` +
        glitter.htmlGenerate.editeInput({
          gvc: gvc,
          title: `字體`,
        ...
        ` <div class="alert alert-primary mt-2">
            ...
            <div class="mb-2" style="width: 100%;height: 1px;background-color: white;"></div>` +
        glitter.htmlGenerate.editeInput({
          gvc: gvc,
          title: `行高`,
    ...
    innerHtml: (gvc, data) => {
      ...
      return gvc.map([
        ...
        `<div class="alert alert-primary mt-2">
          ...
          `
            <input id="palette" value="${data['background-color'] ?? ''}" type="background-color" style="margin-top:10px;" onchange="${gvc.event(
              (e: HTMLInputElement) => {
          ...
          view: () => {
            return gvc.map([
              ...
              EditorElem.select({
                ...
                array: [
                  { title: '是', value: 'repeat' },
                  { title: '否', value: 'no-repeat' },
                ],
              }),
            ]);
          },
  ...
  },
  {
    ...
    innerHtml: (gvc, data) => {
      ...
      return (
        ...
        `
            <input id="palette" value="${data['color'] ?? 'black'}" type="color" style="margin-top:10px;" onchange="${gvc.event(
              (e: HTMLInputElement) => {
