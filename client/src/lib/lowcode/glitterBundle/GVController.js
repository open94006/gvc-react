...
export function init(url, fun, gt) {
    ...
    const glitter = gt !== null && gt !== void 0 ? gt : window.glitter;
    const gvc = new GVC();
    gvc.glitter = glitter;
    gvc.parameter.pageConfig = glitter.nowPageConfig;
    const pageData = fun(gvc, glitter, (_a = glitter.nowPageConfig) === null || _a === void 0 ? void 0 : _a.obj);
    ...
    window.clickMap = (_g = window.clickMap) !== null && _g !== void 0 ? _g : {};
    switch ((_h = gvc.parameter.pageConfig) === null || _h === void 0 ? void 0 : _h.type) {
        case GVCType.Dialog:
            $('#page' + gvc.parameter.pageConfig.id).html(lifeCycle.onCreateView());
