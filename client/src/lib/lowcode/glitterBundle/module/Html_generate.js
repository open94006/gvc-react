...
${obj.gvc.bindView({
    ...
    constructor(setting, hover = [], subdata, root) {
        ...
        setting.map((dd) => {
            var _a, _b, _c, _d, _e;
            dd.css = (_a = dd.css) !== null && _a !== void 0 ? _a : { class: '', style: {} };
        ...
        this.render = (gvc, option = {
            ...
            option = option !== null && option !== void 0 ? option : { class: '', style: '' };
                                    ...
                                    function initialComponent(set) {
                                        ...
                                        for (const a of set) {
                                            if (['code'].indexOf(a.type) === -1) {
                                                if (a.type !== 'widget' &&
                                                    a.type !== 'container' &&
                                                    !gvc.glitter.share.htmlExtension[gvc.glitter.htmlGenerate.configureCDN(gvc.glitter.htmlGenerate.resourceHook(a.js))]) {
                                                    waitAdd.push({
                                            ...
                                            gvc.glitter.htmlGenerate.loadScript(gvc.glitter, [
                                                {
                                                    src: dd.js,
                                                    callback: (data) => {
                                                        data = data[dd.type].render(gvc, dd, setting, hover, subdata).view();
                                            ...
                                            gvc.glitter.htmlGenerate.loadScript(gvc.glitter, [
                                                {
                                                    ...
                                                    callback: (data2) => {
                                                        data = data2[dd.type].render(gvc, dd, setting, hover, subdata).editor();
                                                        if (typeof data === 'string') {
                                                            loading = false;
                                                            gvc.notifyDataChange(component);
                                                        }
                                                    ...
                                                    gvc.bindView(() => {
                                                        ...
                                                        return {
                                                            ...
                                                            view: () => {
                                                                ...
                                                                return [
                                                                    gvc.glitter.htmlGenerate.styleEditor(dd, gvc, dd, {}).editor(gvc, () => {
                                                                        option.refreshAll();
                                                                    }, '模塊容器樣式'),
